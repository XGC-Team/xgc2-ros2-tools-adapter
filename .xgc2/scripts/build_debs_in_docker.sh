...
if [[ -n "$XGC2_APT_OVERLAY_URL" ]]; then
  ...
  ADAPTER_RUNTIME_CLIENT_DEB_VERSION="${ADAPTER_RUNTIME_CLIENT_DEB_VERSION:-0.6.0-10~noble}"
  XGC2_PROTOBUF_DEB_VERSION="${XGC2_PROTOBUF_DEB_VERSION:-0.5.0-12~noble}"
fi
